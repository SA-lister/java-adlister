...
<footer class="text-center text-lg-start bg-light text-muted mb-0 ">
    <section>
        <div class="me-5 d-flex justify-content-center">
            <span>Check out our ads by category:</span>
        </div>
    </section>
    <section
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                    ...
                    <h6 class="text-uppercase fw-bold mb-4">
                        <i class="fas fa-gem me-3"></i>San Antonio Lister
                    </h6>
                    <p>
    ...
    <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
        &copy 2022 Copyright:
        <a class="text-reset fw-bold" href="https://github.com/SA-lister">SA-Lister</a>
    </div>
    <!-- Copyright -->
</footer>